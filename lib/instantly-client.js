...
export class InstantlyClient {
  ...
  async request(endpoint, method = 'GET', body = null) {
    if (process.env.INSTANTLY_ACTIVE === 'false' || !this.apiKey) {
      console.log('⏸️ [INSTANTLY DESCONECTADO] El servicio de Instantly está pausado por apelación de cuenta en Google.');
      return { paused: true, disconnected: true, message: 'Instantly desconectado por seguridad fiduciaria.' };
    }
