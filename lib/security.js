...
export function verifyAdminAuth(req) {
  ...
  // Ese valor estaba duplicado en 10 archivos del proyecto y actuaba como
  // contraseña maestra universal cuando ADMIN_PASSWORD no estaba configurada,
  // anulando por completo el diseño "fail-closed" descrito en los comentarios.
