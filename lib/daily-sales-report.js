...
export async function generateAndSendDailySalesReport({ timeSlot = '6:00 PM' } = {}) {
  ...
  const financialData = {
    ...
    breakdown: [
      { product: 'Boleto de Entrada Fiduciario ($9 USD)', sold: 0, revenue: 0.00 },
    ...
    try {
      ...
      const html = `
        <div style="font-family: Arial, sans-serif; background-color: #0b0f19; color: #ffffff; padding: 25px; border-radius: 10px; max-width: 650px; margin: 0 auto; border: 1px solid #38bdf8;">
          ...
          <!-- CORTE 2:00 PM — PLAN DE REFUERZO EXTREMO (SI NO SE ALCANZA EL 50% DE LA META) -->
          <div style="background-color: #1f1d24; border: 1px solid #ef4444; padding: 18px; border-radius: 8px; margin-bottom: 20px;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
              <h4 style="margin: 0; color: #f87171; font-size: 15px;">🚨 PROTOCOLO 2:00 PM — PLAN DE REFUERZO EXTREMO</h4>
              <span style="font-size: 11px; background: #7f1d1d; color: #fca5a5; padding: 3px 8px; rounded: 4px; font-weight: bold;">ACTIVACIÓN AUTOMÁTICA</span>
            </div>
            <p style="font-size: 13px; color: #cbd5e1; margin-bottom: 12px; line-height: 1.5;">
              Si al corte de las <strong>2:00 PM</strong> la facturación no alcanza el 50% de la meta diaria ($150 USD), el servidor ejecuta de forma autónoma los 4 disparadores de aceleración:
            </p>
            <ul style="margin: 0; padding-left: 20px; font-size: 13px; color: #e2e8f0; line-height: 1.6;">
              <li>⚡ <strong>Gatillo 1 (Oferta Flash 4 Horas - $9 USD):</strong> Despacho de correo con enlace de cobro 1-Clic a precio de entrada $9 USD para carritos y leads tibios.</li>
              <li>🎯 <strong>Gatillo 2 (Acelerador de Retargeting Meta Ads):</strong> Inyección de pauta hiper-enfocada en los visitantes que abrieron la web en las últimas 24h.</li>
              <li>📄 <strong>Gatillo 3 (Muestra Forense Redline):</strong> Envío automático de vista previa de 2 cláusulas de riesgo detectadas para provocar la compra inmediata del Word (.docx).</li>
              <li>🛰️ <strong>Gatillo 4 (Segunda Ola Waalaxy / LinkedIn):</strong> Re-impacto por correo a decisores que registraron aperturas del email matutino.</li>
            </ul>
          </div>

          <!-- PLAN DE CHOQUE 24H (100% DIGITAL Y AUTOMATIZADO) -->
          <div style="background-color: #111827; border: 1px solid #10b981; padding: 15px; border-radius: 6px; margin-bottom: 20px;">
            <h4 style="margin: 0 0 8px 0; color: #34d399; font-size: 14px;">⚡ Plan de Choque Inmediato 100% Digital (Sin contactos personales):</h4>
            <ul style="margin: 0; padding-left: 20px; font-size: 13px; color: #e2e8f0; line-height: 1.6;">
              <li>1. <strong>Recuperación de Carritos por Correo Corporativo:</strong> Despacho automático de email con enlace de 1-Clic ($19 USD) a los correos que iniciaron checkout en las últimas 48h.</li>
              <li>2. <strong>Encendido de Meta Ads B2B:</strong> Activación de pauta hiper-segmentada (CFOs, Gerentes Legales y Contralores) con presupuesto de $35 USD/día directo al checkout 1-Clic.</li>
              <li>3. <strong>Secuencias Automatizadas Waalaxy / LinkedIn:</strong> Envío de borradores forenses en Word (.docx) a los 25 tomadores de decisión reales con enlace fiduciario a $19 USD.</li>
            </ul>
          </div>
