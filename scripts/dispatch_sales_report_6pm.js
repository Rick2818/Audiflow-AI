...
try {
  console.log(`[${new Date().toISOString()}] Ejecutando despacho autónomo de Reporte 6:00 PM (Cierre Diario)...`);
  ...
  if (process.env.GITHUB_STEP_SUMMARY && result?.financialData) {
    ...
    const summaryMd = `
# 📈 AUDITFLOW AI — BALANCE FINANCIERO EJECUTIVO (CIERRE DIARIO 6:00 PM CST)
